...
public class RabbitMqAuthBackend extends RpcServer {

    private AuthBackend authBackend;

    public RabbitMqAuthBackend(Channel channel, AuthBackend authBackend) throws IOException {
        super(channel);
        this.authBackend = authBackend;
        channel.queueBind(getQueueName(), "authentication", "");
    }
