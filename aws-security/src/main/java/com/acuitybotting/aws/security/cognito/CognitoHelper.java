...
/**
 * The CognitoService class abstracts the functionality of connecting to the Cognito user pool and Federated Identities.
 */
class CognitoHelper {
    ...
    public CognitoHelper(String poolId, String clientappId, String fedPoolId, String customDomain, String region, String redirectUrl, String secretKey) {
        this.poolId = poolId;
        this.clientappId = clientappId;
        this.fedPoolId = fedPoolId;
    ...
    String GetHostedSignInURL() {
        ...
        return String.format(customurl, customDomain, region, clientappId, redirectUrl);
    }
    ...
    Credentials getCredentials(String idprovider, String id) {
        ...
        idrequest.setIdentityPoolId(fedPoolId);
